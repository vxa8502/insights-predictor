...
if __name__ == "__main__":
    ...
    print("MODEL VISUALIZER MODULE")
    print("\nAvailable visualization functions:")
    print("  ✓ plot_confusion_matrices()")
    print("  ✓ plot_roc_curves()")
    print("  ✓ plot_metrics_comparison()")
    print("  ✓ plot_training_times()")
    print("  ✓ create_comparison_table_styled()")
    print("  ✓ create_model_dashboard()")
    print("\nUsage example:")
    print("  from visualizations.model_viz import ModelVisualizer")
    print("  viz = ModelVisualizer()")
    print("  viz.create_model_dashboard(results, models, X_test, y_test)")
    print("  viz.plot_roc_curves(trained_models, X_test, y_test)")