...
if __name__ == "__main__":
    ...
    print("DATA VISUALIZER MODULE")
    print("\nAvailable visualization functions:")
    print("  ✓ plot_sentiment_distribution()")
    print("  ✓ generate_wordclouds()")
    print("  ✓ plot_review_length_distribution()")
    print("  ✓ plot_top_words()")
    print("  ✓ plot_rating_distribution()")
    print("  ✓ create_exploratory_dashboard()")
    print("\nUsage example:")
    print("  from visualizations.data_viz import DataVisualizer")
    print("  viz = DataVisualizer()")
    print("  viz.plot_sentiment_distribution(df, save_path='plots/sentiment_dist.png')")
    print("  viz.create_exploratory_dashboard(df, save_path='plots/dashboard.png')")